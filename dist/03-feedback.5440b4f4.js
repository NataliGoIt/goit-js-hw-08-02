...
const LOCALSTORAGE_KEY = "feedback-form-state", formEl = document.querySelector(".feedback-form");
formEl.addEventListener("input", (0, _lodashThrottleDefault.default)(formInput, 500));
...
function formInput(e) {
    ...
    let saveMassages = localStorage.setItem(LOCALSTORAGE_KEY, JSON.stringify(getMassages));
}
